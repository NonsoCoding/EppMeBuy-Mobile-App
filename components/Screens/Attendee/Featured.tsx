...
const Featured = ({
    ...
    const featured = [
        {image: require("../../../assets/images/party.jpg"), title: "International Concert"},
        {image: require("../../../assets/images/party.jpg"), title: "International Concert"},
        {image: require("../../../assets/images/party.jpg"), title: "International Concert"},
        {image: require("../../../assets/images/party.jpg"), title: "International Concert"},
        {image: require("../../../assets/images/party.jpg"), title: "International Concert"},
    ...
    return (
        <View style={[tw`pt-12 flex-1 px-5 flex-1`, {
        ...
        <Text style={[tw`text-xl`, { color: colors.text }]}>
          Featured
                    ...
                    <TouchableOpacity style={[tw`px-2 py-2 rounded-lg`, {
                        ...
                        <Feather size={25} name="more-vertical" color={colors.buttonBackground}/>
                    </TouchableOpacity>
                </View>
                ...
                <View style={[tw`gap-3`, {
                    ...
                    <ImageBackground source={items.image} resizeMode="cover" style={[tw`h-40 p-5 gap-2 justify-center `, {
                    }]}>
                        <Text style={[tw`font-bold text-2xl`, {
                            color: colors.buttonText
                                    }]}>{items.title}</Text>
                        <TouchableOpacity style={[tw`w-25 h-8 items-center justify-center rounded-full`, {
